...
import RamList from "./movie-list";
...
class App extends React.Component {
  ...
  handleSubmit = event => {
    ...
    if (!source || !target) {
      this.setState({ error: "Please select a source and target friend" });
      return;
    }
    ...
    return (
      <div>
        <form onSubmit={this.handleSubmit}>
          <RamList label="Source" handleChange={this.changeSource} />
          <RamList label="Target" handleChange={this.changeTarget} />
